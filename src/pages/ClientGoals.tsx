...
export default function ClientGoals() {
  ...
  if (!client) {
    return (
      <PageShell title="Goals" subtitle="Client not found.">
  ...
  return (
    <PageShell
      title="Goals"
      subtitle="Your short-term and long-term training goals."
    >
      <div className="grid gap-5">
        <GoalCard
          label="Main Goal"
          value={client.goals.mainGoal}
          icon="🎯"
        />

        <GoalCard
          label="Short-Term Goal"
          value={client.goals.shortTerm}
          icon="⚡"
        />

        <GoalCard
          label="Long-Term Goal"
          value={client.goals.longTerm}
          icon="🏆"
        />
      </div>
    </PageShell>
