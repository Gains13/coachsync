...
export default function ClientPlan() {
  ...
  if (!client) {
    return (
      <PageShell title="Client not found" subtitle="Please log in again.">
  ...
  const completedWorkoutTitles = completedSubmissions.map(
    (submission) => submission.workout_title
  );
  ...
  const nextAssignedWorkout = availableWorkouts
            ...
            return (
              ...
              >
                <div className="mb-4 flex items-center justify-between">
                  ...
                  >
                    {week.status === "locked" ? "Locked / Upcoming" : week.status}
                  </span>
                </div>
